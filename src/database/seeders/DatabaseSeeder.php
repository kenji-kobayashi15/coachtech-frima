...
class DatabaseSeeder extends Seeder
{
    ...
    {
        // 1. 商品の状態マスタ作成
        $condition_names = ['良好', '目立った傷や汚れなし', 'やや傷や汚れあり', '状態が悪い'];
        foreach ($condition_names as $name) {
        ...
        foreach ($items as $itemData) {
            ...
            Item::create([
                ...
                'brand' => $itemData['brand'] === 'なし' ? null : $itemData['brand'],
                'description' => $itemData['description'],
                'image_path' => $itemData['img_path'],
